...
async function loadBook() {
  ...
  try {
    // Using relative path for better GitHub Pages compatibility
    ...
    // Fixed: Now defaults to History instead of Chapter 0
    showHistory(); 
...
function showHistory() {
  ...
  // Highlight the first tab (History)
  highlightTab(0);
...
અહીં તેની સચોટ અને વિગતવાર સમજૂતી છે:
      ...
      <b>૧. શું તે અગાઉ પવિત્ર શાસ્ત્રનો ભાગ હતું?</b>
      ...
      <b>૨. કોણે અને ક્યારે આ નિર્ણય લીધો?</b>
      ...
      मानતા હતા કે પ્રબોધકો દ્વારા મળતી ઈશ્વરીય પ્રેરણાનો સમય મલાખી પ્રબોધક સાથે પૂર્ણ થયો હતો.
      ...
      <b>૩. તેને કેમ બાકાત રાખવામાં આવ્યું?</b>
      ...
      <b>૪. ઇથોપિયાના બાઈબલમાં તે કેમ સચવાયેલું છે?</b>
